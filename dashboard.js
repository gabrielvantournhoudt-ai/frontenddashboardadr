(function(){
  ...
  function updateSummaryWidgets(adrs, adrsSnapshots, marketData){
    ...
    const afterRealtime = (tickers.length && isAfterHoursClient()) ? getSnapshotTotals(snapshots, tickers, 'after_hours') : null;
  ...
  // Inicializar análise manager se disponível
  if (typeof analysisManager !== 'undefined') {
    analysisManager.updateUI();
  }
})();
